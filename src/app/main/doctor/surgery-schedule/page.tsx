  ...
  return (
    <div className="space-y-6">
      <main className="flex-1 w-full px-2 md:px-6 lg:px-12 xl:px-24 2xl:px-48 py-6">
                  ...
                  {filteredSurgeries.map((surgery) => (
                    <TableRow key={surgery.id}>
                      ...
                      <TableCell className="text-center">
                        {surgery.aiAssist ? <Bot className="h-5 w-5 text-primary inline-block" /> : <Stethoscope className="h-5 w-5 text-muted-foreground inline-block" />}
                      </TableCell>
                      <TableCell>
        ...
        <Card className="shadow-lg rounded-xl bg-gradient-to-br from-primary/80 to-accent/80 text-primary-foreground w-full">
            <CardHeader>
